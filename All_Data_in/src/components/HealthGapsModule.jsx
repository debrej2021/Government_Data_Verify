...
// ─── DATA SOURCES ──────────────────────────────────────────────────────────
// Snakebite: The Lancet 2020, ICMR, MoHFW NTP Snakebite 2022
// Antivenom & Facility: HMIS Annual Reports, NHM Rural Health Statistics 2023
// Doctor vacancy: Rural Health Statistics 2023, MoHFW

// State-wise snakebite burden
// Reported = officially recorded deaths (NCRB/hospital)
// Actual = Lancet/ICMR modelled estimate (massive underreporting gap)
...
// Facility-level antivenom availability %
// Source: NHM facility surveys, HMIS infrastructure data
const FACILITY_DATA = [
...
// Doctor vacancy at CHC (specialist posts)
// Source: Rural Health Statistics 2023
...
// Tribal district health gap (Aspirational Districts correlation)
// High snakebite burden + low antivenom = crisis zones
...
export default function HealthGapsModule() {
  const [tab, setTab] = useState("snakebite");
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{
            ...
            fontSize: 36, letterSpacing: 4, color: "#ff4444", lineHeight: 1
          }}>
            HEALTH GAPS
          </div>
          <div style={{ fontSize: 12, color: "#555", letterSpacing: 3, marginTop: 4 }}>
            SNAKEBITE CRISIS · ANTIVENOM VOIDS · DOCTOR VACANCIES · TRIBAL DISTRICTS
          </div>
        </div>
        <div style={{
          ...
          SOURCE · THE LANCET 2020 · ICMR · HMIS<br />
          NHM RURAL HEALTH STATISTICS 2023
        </div>
      </div>
      ...
      <div style={{
        ...
        India has ~58,000 snakebite deaths per year (The Lancet 2020) — the highest in the world.
        Only ~3,000 are officially reported. The gap is not a data problem. It is a governance problem.
      ...
      <div style={{
        ...
        {[
          ...
          <button key={t.id} onClick={() => setTab(t.id)} style={{
            ...
            borderBottom: tab === t.id ? "2px solid #ff4444" : "2px solid transparent",
            color: tab === t.id ? "#ff4444" : "#444",
      ...
      <div style={{ padding: "32px 40px" }}>
        ...
        {tab === "snakebite" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              REPORTED VS ACTUAL SNAKEBITE DEATHS · THE REPORTING GAP IS THE CRISIS
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 20, fontFamily: "monospace" }}>
              REPORTED = NCRB/HOSPITAL DATA · ACTUAL = THE LANCET 2020 MODELLED ESTIMATE
            </div>
            <ResponsiveContainer width="100%" height={400}>
              <BarChart
                data={[...SNAKEBITE_DATA].sort((a, b) => b.actual - a.actual)}
              ...
              >
                ...
                <Legend
                  wrapperStyle={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, paddingTop: 16 }}
                />
                <Bar dataKey="actual"   name="Actual (Lancet estimate)" fill="#ff444455" radius={[2, 2, 0, 0]} />
            ...
            <div style={{
              ...
              ⚠ &nbsp;India accounts for nearly 50% of global snakebite deaths.
              &nbsp;Most occur in rural/tribal areas at night with no transport to reach antivenom.
              &nbsp;Snakebite was designated a Neglected Tropical Disease by WHO in 2017.
              &nbsp;India launched a national programme in Sept 2022 — implementation is still nascent.
            </div>
          </>
        )}
        ...
        {tab === "facility" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              ANTIVENOM AVAILABILITY BY FACILITY LEVEL · % OF FACILITIES STOCKED
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 24, fontFamily: "monospace" }}>
              SNAKEBITE VICTIMS REACH PHC/SUB-CENTRE FIRST · THAT IS WHERE STOCK IS LOWEST
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }}>
                ...
                {FACILITY_DATA.map((d, i) => (
                  <div key={i} style={{ marginBottom: 20 }}>
                    <div style={{
                      ...
                      <span style={{
                        color: d.availability < 30 ? "#ff2222" : d.availability < 60 ? "#ff8800" : "#00c896"
                      }}>
                        {d.availability}%
                      </span>
                    </div>
                    <div style={{ height: 8, background: "#111", borderRadius: 4, overflow: "hidden" }}>
                      <div style={{
                        ...
                        background: d.availability < 30 ? "#ff2222" : d.availability < 60 ? "#ff8800" : "#00c896",
                        borderRadius: 4, transition: "width 0.8s ease"
                      }} />
                    </div>
                    <div style={{ fontSize: 9, color: "#333", marginTop: 4, fontFamily: "monospace" }}>
                      {d.desc}
                    </div>
                  </div>
                ))}
              ...
              <div>
                <div style={{ fontSize: 10, color: "#444", letterSpacing: 2, marginBottom: 16 }}>
                  STATE-WISE PHC ANTIVENOM AVAILABILITY %
                </div>
                <ResponsiveContainer width="100%" height={340}>
                  <BarChart
                    data={[...SNAKEBITE_DATA].sort((a, b) => a.antivenom - b.antivenom)}
                    layout="vertical"
                  ...
                  >
                    ...
                    <YAxis
                      ...
                      tick={{ fill: "#888", fontSize: 9, fontFamily: "IBM Plex Mono" }}
        ...
        {tab === "doctors" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              SPECIALIST DOCTOR VACANCY AT COMMUNITY HEALTH CENTRES · INDIA · 2023
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 24, fontFamily: "monospace" }}>
              SOURCE · RURAL HEALTH STATISTICS 2023 · MOHFW
              &nbsp;|&nbsp; CHC IS THE FIRST POINT OF SPECIALIST CARE FOR RURAL INDIA
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, marginBottom: 32 }}>
              {DOCTOR_VACANCY.map((d, i) => (
                <div key={i} style={{
                  ...
                  <div style={{
                    fontFamily: "'Bebas Neue', sans-serif",
                    fontSize: 48, color: "#ff2222", lineHeight: 1, marginBottom: 8
                  }}>
                    {d.vacancy}%
                  </div>
                  <div style={{
                    fontFamily: "'IBM Plex Mono', monospace",
                    fontSize: 13, color: "#cc6666", marginBottom: 8
                  }}>
                    {d.speciality} VACANCY
                  </div>
                  <div style={{ height: 4, background: "#1a0000", borderRadius: 2, overflow: "hidden", marginBottom: 8 }}>
                    <div style={{
                      height: "100%", width: `${d.vacancy}%`,
                      background: "#ff2222", borderRadius: 2
                    }} />
                  </div>
                  <div style={{ fontSize: 10, color: "#553333", fontFamily: "monospace" }}>
                    {d.inPosition.toLocaleString()} of {d.sanctioned.toLocaleString()} posts filled
                  </div>
                </div>
              ))}
            </div>
            ...
            <div style={{
              ...
              ⚠ &nbsp;Over 80% of specialist posts at Community Health Centres are vacant.
              &nbsp;A CHC serves a population of 80,000–1,20,000 in rural India.
              &nbsp;A snakebite victim reaching a CHC at night has an 80% chance of finding no specialist.
              &nbsp;Source: Rural Health Statistics 2023, MoHFW.
            </div>
          </>
        )}
        ...
        {tab === "crisis" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              HIGH SNAKEBITE BURDEN DISTRICTS WITH NO ANTIVENOM WITHIN REACH
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 20, fontFamily: "monospace" }}>
              "NEAREST" = DISTANCE TO NEAREST FACILITY WITH CONFIRMED ANTIVENOM STOCK
              &nbsp;|&nbsp; SOURCE: NHM FACILITY SURVEYS, DISTRICT HEALTH REPORTS
            </div>
                ...
                <tr>
                  {["DISTRICT", "STATE", "SNAKEBITE BURDEN", "ANTIVENOM STATUS", "NEAREST STOCK"].map((h, i) => (
                    <th key={i} style={{
                      ...
                      color: "#444", letterSpacing: 2, fontWeight: 400,
                      borderBottom: "1px solid #1a1a1a", fontSize: 10
                    }}>
                      {h}
                    </th>
                  ))}
                ...
                {CRISIS_DISTRICTS.map((d, i) => (
                  <tr key={i} style={{ borderBottom: "1px solid #0d0d0d" }}>
                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <span style={{
                        color: RISK_COLOR[d.snakebite],
                        background: `${RISK_COLOR[d.snakebite]}22`,
                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <span style={{
                        color: AVAIL_COLOR[d.antivenom] || "#ffcc00",
                        background: `${(AVAIL_COLOR[d.antivenom] || "#ffcc00")}22`,
                        padding: "2px 8px", borderRadius: 2, fontSize: 10
                      }}>
                        {d.antivenom}
                      </span>
                    ...
                    <td style={{
                      padding: "12px 16px",
                      color: parseInt(d.nearest) > 80 ? "#ff2222" : "#ff8800",
                      fontWeight: 600
                    }}>
                      {d.nearest}
                    </td>
            ...
            <div style={{
              ...
              ⚠ &nbsp;Notice: Kandhamal, Malkangiri, Gumla, Bijapur, Narayanpur —
              &nbsp;all are Aspirational Districts with high tribal population.
              &nbsp;The overlap between "underdeveloped district" and "no antivenom" is not a coincidence.
              &nbsp;It is the same administrative failure showing up in two different datasets.
            </div>
          </>
        )}
      </div>
