...
// ─── DATA — NCRB 2022/2023, CHRI Sep 2024, Project 39A, Factly ────────────
...
// Death Penalty Data — Source: Project 39A, Factly, NCRB, CHRI
const DEATH_PENALTY_TREND = [
  ...
  { year: "2004", sentenced: 95,  executed: 1, deathRow: 0   }, // Dhananjoy
  ...
  { year: "2012", sentenced: 68,  executed: 1, deathRow: 0   }, // Kasab
  { year: "2013", sentenced: 72,  executed: 1, deathRow: 0   }, // Afzal Guru
  { year: "2014", sentenced: 98,  executed: 0, deathRow: 385 },
  { year: "2015", sentenced: 112, executed: 1, deathRow: 400 }, // Yakub Memon
  ...
  { year: "2020", sentenced: 77,  executed: 4, deathRow: 488 }, // Nirbhaya x4
...
// Executions split by category
const EXECUTIONS_WOMEN = [
  {
    year: 2004,
    name: "Dhananjoy Chatterjee",
    victim: "Hetal Parekh, 18 years old",
    crime: "Rape & murder in her own apartment building where he worked as a security guard. Executed after 14 years on death row.",
    prison: "Alipore Central Jail, Kolkata",
    years_on_row: 14,
    note: "First execution in India after an 8-year gap since 1995."
  },
  {
    year: 2020,
    name: "Mukesh Singh",
    victim: "Jyoti Singh — Nirbhaya — 23 years old",
    crime: "Gangrape & murder on a moving bus in Delhi on December 16, 2012. One of four executed simultaneously.",
    prison: "Tihar Jail, Delhi",
    years_on_row: 7,
    note: "All four Nirbhaya convicts were hanged simultaneously at 5:30 AM on March 20, 2020."
  },
  {
    year: 2020,
...
const EXECUTIONS_TERROR = [
  {
    year: 2012,
    name: "Ajmal Kasab",
    crime: "26/11 Mumbai terror attack — 166 people killed. Only surviving gunman. Hanged secretly to avoid protests.",
    prison: "Yerwada Jail, Pune",
    years_on_row: 4,
  },
  {
    year: 2013,
    name: "Afzal Guru",
    crime: "2001 Indian Parliament attack — 9 security personnel killed. Family was not informed before hanging.",
    prison: "Tihar Jail, Delhi",
    years_on_row: 11,
  },
  {
    year: 2015,
    name: "Yakub Memon",
    crime: "1993 Bombay serial blasts — 257 killed, 713 injured. Spent 21 years on death row — longest of all 8.",
  ...
  return (
    <div style={{
      ...
      {payload.map((p, i) => (
        <p key={i} style={{ color: "#e0e0e0", margin: "2px 0" }}>
          {p.name}: {p.value}
          {p.dataKey === "executed" && p.value > 0 && " ← EXECUTION YEAR"}
        </p>
      ))}
    </div>
  );
...
export default function CrimesModule() {
  ...
  const currentDeathRow = DEATH_PENALTY_TREND[DEATH_PENALTY_TREND.length - 1].deathRow;
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{
            ...
            fontSize: 36, letterSpacing: 4, color: "#ff2222", lineHeight: 1
          }}>
            CRIMES AGAINST WOMEN · DEATH PENALTY
          </div>
          <div style={{ fontSize: 12, color: "#555", letterSpacing: 3, marginTop: 4 }}>
            NCRB 2023 · CONVICTION RATES · JUSTICE GAP · CAPITAL PUNISHMENT DATA
          </div>
        </div>
        <div style={{
          ...
          SOURCE · NCRB 2022/2023 · CHRI SEP 2024<br />
          PROJECT 39A · FACTLY · NFHS-5
        </div>
      </div>
      ...
      <div style={{
        ...
        4,71,000 crimes against women in 2023 — 51/hour. Only 27.8% rape conviction rate.
        3,026 death sentences since 2001. Only 8 executions carried out.
      ...
      <div style={{
        ...
        {[
          ...
          <button key={t.id} onClick={() => setTab(t.id)} style={{
            ...
            borderBottom: tab === t.id ? "2px solid #ff2222" : "2px solid transparent",
            color: tab === t.id ? "#ff2222" : "#444",
      ...
      <div style={{ padding: "32px 40px" }}>
        ...
        {tab === "overview" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              TOTAL CRIMES AGAINST WOMEN · 2017–2023
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 20, fontFamily: "monospace" }}>
              2020 DIP = COVID LOCKDOWN — FEWER COMPLAINTS FILED, NOT FEWER CRIMES
            </div>
        ...
        {tab === "states" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              CRIME RATE PER LAKH WOMEN · STATE-WISE · NCRB 2022
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 20, fontFamily: "monospace" }}>
              NATIONAL AVERAGE: 66.4 · DELHI IS 2.17X THE NATIONAL AVERAGE
            </div>
              ...
              <BarChart data={STATE_CRIME_RATE} margin={{ top: 0, right: 20, left: 20, bottom: 80 }}>
                ...
                <Bar dataKey="rate" name="Crime rate" radius={[2, 2, 0, 0]}>
                  {STATE_CRIME_RATE.map((d, i) => (
                    <Cell key={i} fill={d.state === "National Avg" ? "#ffdd00" : d.rate > 100 ? "#ff2222" : d.rate > 66.4 ? "#ff8800" : "#00c896"} fillOpacity={0.8} />
                  ))}
                </Bar>
              </BarChart>
            </ResponsiveContainer>
        ...
        {tab === "conviction" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              RAPE CASE DISPOSAL · CONVICTION VS ACQUITTAL VS PENDING · 2017–2022
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 20, fontFamily: "monospace" }}>
              SOURCE · CHRI ANALYSIS OF NCRB DATA · SEP 2024 · CONVICTION NEVER CROSSED 20%
            </div>
            ...
            <div style={{ marginTop: 24, padding: "16px 20px", background: "#0a0000", border: "1px solid #330000", fontFamily: "monospace", fontSize: 11, color: "#884444", lineHeight: 1.8 }}>
              ⚠ &nbsp;78.66% of rape cases in trial courts were still pending in 2022.
              &nbsp;Conviction peaked at 15.38% for rape/gangrape with murder.
              &nbsp;Source: CHRI Analysis of NCRB Data, September 2024.
            </div>
          </>
        )}
        ...
        {tab === "justice" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 24 }}>
              JUSTICE SYSTEM SCORECARD · CRIMES AGAINST WOMEN · INDIA 2023
            </div>
            ...
            <div style={{ marginTop: 24, padding: "16px 20px", background: "#0a0000", border: "1px solid #330000", fontFamily: "monospace", fontSize: 11, color: "#884444", lineHeight: 1.8 }}>
              ⚠ &nbsp;29.3% of married women experienced spousal violence (NFHS-5).
              &nbsp;This number never appears in NCRB because it is almost never reported.
              &nbsp;The gap between NFHS and NCRB is not a data gap. It is a justice gap.
            </div>
          </>
        )}
        ...
        {tab === "death" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              DEATH SENTENCES AWARDED VS EXECUTIONS CARRIED OUT · 2001–2024
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 20, fontFamily: "monospace" }}>
              SOURCE · PROJECT 39A · FACTLY · NCRB · {totalSentenced.toLocaleString()} SENTENCED · ONLY {totalExecuted} EXECUTED
            </div>
            ...
            {/* Crimes against women — executed */}
            <div style={{ marginTop: 32 }}>
              <div style={{
                fontSize: 11, color: "#ff4444", letterSpacing: 3, marginBottom: 16,
                fontFamily: "'IBM Plex Mono', monospace",
                borderLeft: "3px solid #ff4444", paddingLeft: 12
              }}>
                EXECUTED FOR CRIMES AGAINST WOMEN · {EXECUTIONS_WOMEN.length} SOULS
              </div>
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                      <div>
                        <span style={{
                          fontFamily: "'Bebas Neue', sans-serif",
                          fontSize: 22, color: "#ff2222", letterSpacing: 2, marginRight: 12
                        }}>{d.year}</span>
                        <span style={{
                          fontFamily: "'IBM Plex Mono', monospace",
                      ...
                      <span style={{
                        fontFamily: "'IBM Plex Mono', monospace",
                        fontSize: 10, color: d.years_on_row > 10 ? "#ff8800" : "#666",
                        whiteSpace: "nowrap"
                      }}>
                        {d.years_on_row} yrs on death row
                      </span>
                    </div>
                    <div style={{ fontSize: 11, color: "#ff88aa", fontFamily: "monospace", marginBottom: 6 }}>
                      VICTIM · {d.victim}
                    </div>
                    <div style={{ fontSize: 10, color: "#666", fontFamily: "monospace", marginBottom: 6, lineHeight: 1.6 }}>
                      {d.crime}
                    </div>
                    <div style={{ fontSize: 10, color: "#333", fontFamily: "monospace", fontStyle: "italic" }}>
                      {d.prison} · {d.note}
                    </div>
                  </div>
                ))}
            ...
            {/* Terror cases — separate */}
            <div style={{ marginTop: 32 }}>
              <div style={{
                fontSize: 11, color: "#888", letterSpacing: 3, marginBottom: 16,
                fontFamily: "'IBM Plex Mono', monospace",
                borderLeft: "3px solid #555", paddingLeft: 12
              }}>
                EXECUTED FOR TERRORISM · {EXECUTIONS_TERROR.length} CASES · SEPARATE CATEGORY
              </div>
              <div style={{ display: "grid", gap: 8 }}>
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                      <div>
                        <span style={{
                          fontFamily: "'Bebas Neue', sans-serif",
                          fontSize: 22, color: "#888", letterSpacing: 2, marginRight: 12
                        }}>{d.year}</span>
                        <span style={{
                          fontFamily: "'IBM Plex Mono', monospace",
                    ...
                    <div style={{ fontSize: 10, color: "#666", fontFamily: "monospace", lineHeight: 1.6 }}>
                      {d.crime}
                    </div>
            ...
            <div style={{ marginTop: 24, padding: "16px 20px", background: "#0a0000", border: "1px solid #330000", fontFamily: "monospace", fontSize: 11, color: "#884444", lineHeight: 1.8 }}>
              ⚠ &nbsp;3,026 death sentences awarded by trial courts between 2001–2023.
              &nbsp;Only 8 executions actually carried out — a ratio of 378:1.
              &nbsp;564 people currently live under a death sentence in Indian prisons — the highest in over 20 years.
              &nbsp;Yakub Memon spent 21 years on death row. Dhananjoy Chatterjee spent 14 years.
              &nbsp;Source: Project 39A Annual Death Penalty Report 2024, Factly, NCRB.
            </div>
          </>
        )}
      </div>
