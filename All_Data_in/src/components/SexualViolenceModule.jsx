...
// ─── DATA ──────────────────────────────────────────────────────────────────
// Sources: NCRB 2023, CHRI Sep 2024, US State Dept TIP Report 2025,
// UNODC, Grokipedia, IndiaDataMap

// Rape + Murder (sexual assault leading to homicide) — NCRB
...
// State-wise rape + murder 2022 (NCRB)
...
// Human trafficking state-wise 2023 (NCRB)
...
// Trafficking purpose breakdown 2023 (NCRB)
const PURPOSE_DATA = [
...
// Trafficking conviction/acquittal (US State Dept TIP / NCRB 2021)
...
// Cultural / structural trafficking systems
const STRUCTURAL_TRAFFICKING = [
  {
    system: "Devadasi System",
    states: "Karnataka, Andhra Pradesh, Tamil Nadu",
    desc: "Girls from lower castes ritually 'dedicated' to temples from ages 13–15. Normalised as religious practice. Estimated 250,000–450,000 devadasis in India, many forced into sex work.",
    status: "Illegal since 1988 under Karnataka Devadasi Act. Still practiced in rural areas.",
    color: "#ff4444"
  },
  {
    system: "Bedia / Banchhara Community",
    states: "Madhya Pradesh, Rajasthan, UP",
    desc: "Caste-based tradition where girls are groomed for prostitution from ages 13–15 as a familial economic strategy. NCRB notes MP topped child trafficking cases in 2019 partly due to this.",
    status: "No specific law targeting caste-based trafficking traditions.",
    color: "#ff8800"
  },
  {
    system: "Cross-Border Trafficking",
    states: "West Bengal, Bihar, Assam, UP",
    desc: "Nepal and Bangladesh border states are primary source/transit points. Of 955 Maharashtra victims in 2023 — 4 Nepalese, 23 Bangladeshi nationals among those rescued.",
    status: "SAARC Convention on Trafficking signed. Ground-level enforcement inadequate.",
    color: "#ffcc00"
  },
  {
    system: "Missing Children Pipeline",
    states: "All states — Maharashtra worst",
    desc: "4,619 children went missing in Maharashtra in 2023. 2,347 were girls. Only 2,574 traced. Missing children are the feeder pipeline into trafficking networks.",
    status: "1,22,248 persons missing in Maharashtra till 2023. 71,079 traced. 51,169 still untraced.",
    color: "#aa44ff"
  },
];
...
export default function SexualViolenceModule() {
  const [tab, setTab] = useState("rapemurder");
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{
            ...
            fontSize: 36, letterSpacing: 4, color: "#ff2244", lineHeight: 1
          }}>
            SEXUAL VIOLENCE & TRAFFICKING
          </div>
          <div style={{ fontSize: 12, color: "#555", letterSpacing: 3, marginTop: 4 }}>
            RAPE + MURDER · HUMAN TRAFFICKING · FORCED EXPLOITATION · STRUCTURAL CAUSES
          </div>
        </div>
        <div style={{
          ...
          SOURCE · NCRB 2023 · US STATE DEPT TIP 2025<br />
          CHRI · UNODC · MINISTRY OF WCD
        </div>
      </div>
      ...
      <div style={{
        ...
        852 women trafficked for prostitution in Maharashtra alone in 2023.
        Trafficking conviction rate: 10%. Acquittal rate: 84%.
        Devadasi system still active despite being illegal since 1988.
      ...
      <div style={{
        ...
        {[
          ...
          <button key={t.id} onClick={() => setTab(t.id)} style={{
            ...
            borderBottom: tab === t.id ? "2px solid #ff2244" : "2px solid transparent",
            color: tab === t.id ? "#ff2244" : "#444",
      ...
      <div style={{ padding: "32px 40px" }}>
        ...
        {tab === "rapemurder" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              RAPE / GANGRAPE WITH MURDER · INDIA · 2018–2023
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 24, fontFamily: "monospace" }}>
              CONVICTION RATE PEAKED AT 15.38% IN 2022 — NEVER CROSSED 16% IN ANY YEAR
            </div>
            ...
            <div style={{ marginTop: 32 }}>
              <div style={{ fontSize: 10, color: "#444", letterSpacing: 2, marginBottom: 16 }}>
                STATE-WISE RAPE + MURDER CASES · 2022
              </div>
            ...
            <div style={{ marginTop: 20, padding: "14px 20px", background: "#0a0000", border: "1px solid #330000", fontFamily: "monospace", fontSize: 11, color: "#884444", lineHeight: 1.8 }}>
              ⚠ &nbsp;UP, MP and Rajasthan account for nearly 45% of all rape + murder cases nationally.
              &nbsp;These are the same three states that consistently top rape statistics too.
              &nbsp;The conviction rate for rape with murder has never crossed 16% in any year — CHRI Sep 2024.
            </div>
          </>
        )}
        ...
        {tab === "trafficking" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              HUMAN TRAFFICKING STATE-WISE · 2023 · VICTIMS RESCUED
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 24, fontFamily: "monospace" }}>
              852 WOMEN TRAFFICKED FOR PROSTITUTION IN MAHARASHTRA ALONE · NCRB 2023
            </div>
        ...
        {tab === "justice" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              TRAFFICKING JUSTICE SCORECARD · INDIA · 2021 DATA (LATEST AVAILABLE)
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 24, fontFamily: "monospace" }}>
              SOURCE · US STATE DEPT TRAFFICKING IN PERSONS REPORT 2023 / NCRB 2021
            </div>

            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 32 }}>
              {TRAFFICKING_JUSTICE.map((item, i) => (
                <div key={i} style={{
                  padding: "20px 24px", background: "#0a0000",
                  border: "1px solid #1a0000", borderLeft: `3px solid ${item.color}`
                }}>
                  <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 48, color: item.color, lineHeight: 1, marginBottom: 6 }}>
                    {item.value.toLocaleString()}
                  </div>
                  <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 11, color: "#cc6666" }}>
                    {item.label}
                  </div>
                </div>
              ))}
            ...
            <div style={{ marginBottom: 24, padding: "16px 20px", background: "#0a0000", border: "1px solid #330000", fontFamily: "monospace", fontSize: 11, color: "#884444", lineHeight: 1.8 }}>
              ⚠ &nbsp;For every 1 trafficker convicted, 8 suspects are acquitted.
              &nbsp;Acquittal rate: 84%. Conviction rate: 10%.
              &nbsp;Only 1 Anti-Human Trafficking Unit (AHTU) for every 10 states — staffing is critically inadequate.
              &nbsp;NCRB did not issue 2023 Crime in India Report for trafficking — "unspecified reasons." (US State Dept TIP 2025)
            </div>

            {/* Missing persons link */}
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 16 }}>
              MISSING PERSONS — THE FEEDER PIPELINE
            </div>
            {[
              ...
              <div key={i} style={{
                ...
                padding: "14px 20px", marginBottom: 6,
                background: "#0a0000", borderLeft: `3px solid ${item.color}`
              }}>
                <div>
                ...
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 28, color: item.color, letterSpacing: 2 }}>
                  {item.value}
                </div>
              </div>
            ))}
        ...
        {tab === "structural" && (
          <>
            <div style={{ fontSize: 11, color: "#444", letterSpacing: 2, marginBottom: 6 }}>
              STRUCTURAL & CULTURAL ROOT CAUSES · THE SYSTEMS THAT FEED TRAFFICKING
            </div>
            <div style={{ fontSize: 10, color: "#553333", marginBottom: 24, fontFamily: "monospace" }}>
              DATA FROM ETHNOGRAPHIC STUDIES · MINISTRY OF WCD · UNODC · GROKIPEDIA
            </div>
              ...
              {STRUCTURAL_TRAFFICKING.map((item, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                    <div style={{
                      fontFamily: "'Bebas Neue', sans-serif",
                      fontSize: 22, color: item.color, letterSpacing: 2
                    }}>
                      {item.system}
                    </div>
                    <span style={{
                      ...
                      background: "#111", padding: "3px 8px", borderRadius: 2
                    }}>
                      {item.states}
                    </span>
                  </div>
                  <div style={{ fontSize: 11, color: "#888", fontFamily: "monospace", marginBottom: 8, lineHeight: 1.7 }}>
                    {item.desc}
                  </div>
                  <div style={{ fontSize: 10, color: item.color, fontFamily: "monospace", fontStyle: "italic" }}>
                    STATUS · {item.status}
                  </div>
                </div>
              ))}
            ...
            <div style={{ marginTop: 24, padding: "16px 20px", background: "#0a0000", border: "1px solid #330000", fontFamily: "monospace", fontSize: 11, color: "#884444", lineHeight: 1.8 }}>
              ⚠ &nbsp;The Devadasi system has been illegal for 36 years. It is still practiced.
              &nbsp;The Bedia community has no specific law targeting their trafficking traditions.
              &nbsp;These are not "crimes in the shadows" — they are known, documented, and tolerated.
              &nbsp;The failure is not awareness. The failure is political will.
            </div>
          </>
        )}
      </div>
